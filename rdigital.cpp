...
void RDigital::botons() {
    ui->c_blanc->setIcon(QIcon("/home/pi/prova15/imatges/blanc4.jpeg"));
    ui->c_blanc->setIconSize(QSize(65,65));

    ui->c_negre->setIcon(QIcon("/home/pi/prova15/imatges/negre2.png"));
    ui->c_negre->setIconSize(QSize(65,65));

    ui->pushButton->setIcon(QIcon("/home/pi/prova15/imatges/fontubuntu2.png"));
    ui->pushButton->setIconSize(QSize(65,65));

    ui->pushButton_2->setIcon(QIcon("/home/pi/prova15/imatges/7segment.jpg"));
    ui->pushButton_2->setIconSize(QSize(65,65));

    ui->pushButton_4->setIcon(QIcon("/home/pi/prova15/imatges/datalletres2.jpg"));
    ui->pushButton_4->setIconSize(QSize(65,65));

    ui->pushButton_3->setIcon(QIcon("/home/pi/prova15/imatges/datanum.jpg"));
    ui->pushButton_3->setIconSize(QSize(65,65));

    ui->pb_analogclock->setIcon(QIcon("/home/pi/prova15/imatges/dretabo.png"));
    ui->pb_analogclock->setIconSize(QSize(65,320));

    ui->pb_calaix->setIcon(QIcon("/home/pi/prova15/imatges/esquerra.png"));
